...
def __get_dataset(net, iterType):
    ...
    for line in __iter_all_data(net, iterType):
        ...
        if len(info) == 70:
            bbox['jaw'] = info[0:16]#[2:18]
            bbox['left_eyebrow'] = info[17:21]#[19:23]
            bbox['right_eyebrow'] = info[22:26]#[24:28]
            bbox['nose'] = info[27:35]#[29:37]
            bbox['left_eye'] = info[36:41]#[38:43]
            bbox['right_eye'] = info[42:47]#[44:49]
            bbox['mouth'] = info[48:67]#[50:69]
